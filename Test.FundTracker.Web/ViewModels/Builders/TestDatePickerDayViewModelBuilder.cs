...
namespace Test.FundTracker.Web.ViewModels.Builders
{
    ...
    public class TestDatePickerDayViewModelBuilder
    {
        ...
        public void Returns_entry_for_all_days_in_selected_month(int selectedMonth, int expectedNumberOfDays)
        {
            ...
            var datePickerDays = datePickerViewModelBuilder.Build(selectedDate);
        ...
        [Test]
        public void Sets_day_text_with_zeros_when_less_than_10()
        {
            ...
            for (int i = 1; i < 10; i++)
            {
                ...
                Assert.That(datePickerDay, Is.EqualTo("0" + i));
            }
        }

        [Test]
        public void Sets_day_text_without_zeros_when_10_or_more()
        {
            var selectedDate = new DateTime(2014, 9, 14);
            ...
            {
                var datePickerDay = datePickerDays[i - 1];
                Assert.That(datePickerDay, Is.EqualTo("" + i));
            }
        }
